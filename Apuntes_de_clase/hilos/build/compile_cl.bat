...
cl /nologo /O2 /GR- /EHs /W3 /MD /D _CRT_SECURE_NO_WARNINGS -I ..\include -I ..\deps\esat\include /c ..\src\bmp.cc
cl /nologo /O2 /GR- /EHs /W3 /MD /D _CRT_SECURE_NO_WARNINGS -I ..\include -I ..\deps\esat\include /c ..\src\threads_example.cc
